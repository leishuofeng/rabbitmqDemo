...
public class RabbitmqConsumer {
    private static final String EXCHANGE_NAME = "交换机001";
    private static final String ROUTING_KEY = "路由001";
    private static final String QUEUE_NAME = "队列001";

    public static void main(String[] args) throws IOException, TimeoutException, InterruptedException {
        Address[] addresses = new Address[]{
                new Address(RabbitmqPropertiesTools.getValue("rabbitmqConnectHost"),Integer.parseInt(RabbitmqPropertiesTools.getValue("rabbitmqClientPort")))
        };
